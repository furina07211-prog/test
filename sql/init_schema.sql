CREATE DATABASE IF NOT EXISTS fruit_warehouse_manage
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='水果档案表';
...
CREATE TABLE IF NOT EXISTS purchase_order_item (
    ...
    KEY idx_poi_expiration (expiration_date),
    ...
    CONSTRAINT chk_poi_qty CHECK (quantity >= 0 AND received_qty >= 0)
...
CREATE TABLE IF NOT EXISTS inventory_batch (
    ...
    KEY idx_inv_fruit_wh_exp (fruit_id, warehouse_id, expiration_date),
    ...
    CONSTRAINT chk_inv_qty CHECK (total_qty >= 0 AND available_qty >= 0 AND locked_qty >= 0)
...
CREATE TABLE IF NOT EXISTS inventory_txn (
    ...
    KEY idx_txn_batch_time (batch_id, txn_time),
...
CREATE TABLE IF NOT EXISTS stock_check_order (
    ...
    KEY idx_sco_status_date (check_status, check_date),
...
CREATE TABLE IF NOT EXISTS ai_forecast_result (
    ...
    KEY idx_forecast_query (fruit_id, forecast_date),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='AI采购建议表';
